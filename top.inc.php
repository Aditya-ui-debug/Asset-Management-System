<?php
require('db.inc.php');
// This checks if the ROLE key is not set in the $_SESSION superglobal array. This is typically used to verify if a user is logged in.
         ...
         <header id="header" class="header">
            <div class="top-left">
               <div class="navbar-header">
                  <a class="navbar-brand" href="index.php"><img src="images/THDCIL.webp" alt="Logo"></a>
            ...
            <div class="top-right">
               <div class="header-menu">
                  <div class="user-area dropdown float-right">
                     <!-- welcome user on the basis of there name -->
